<template>
  <div>
      ...
      <h5 class="transactions" v-bind:transaction="transaction" v-for="transaction in transactions" v-bind:key="transaction.id">
        {{transaction}}

      </h5>
      <div class="reviews container">
        <review-card v-bind:review="review" v-for="review in reviews" v-bind:key="review.id"> 
      ...
      <div class="photo-container" v-bind:photo="photo" v-for="photo in restaurant.photos" v-bind:key="photo.id">
